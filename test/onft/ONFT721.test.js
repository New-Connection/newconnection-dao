...
describe("ONFT721: ", function () {
    ...
    it("sendFrom() - your own tokens", async function () {
        ...
        await expect(ONFT_B.ownerOf(tokenId)).revertedWith("ERC721: owner query for nonexistent token")
        ...
        // token is burnt
        await expect(ONFT_A.ownerOf(tokenId)).revertedWith("ERC721: owner query for nonexistent token")
